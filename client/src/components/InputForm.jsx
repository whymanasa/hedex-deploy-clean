        ...
        <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
          ...
          <div className="flex space-x-2">
            ...
            <div className="flex flex-col space-y-3">
              <button
                type="submit"
                className="px-6 py-3 bg-[#4E6688] text-[#E3EEB2] rounded-md hover:bg-[#332D56] disabled:opacity-50 transition-all duration-200 transform hover:scale-105 hover:shadow-lg flex items-center justify-center min-w-[120px] font-medium"
              ...
              <button
                ...
                className="px-6 py-3 bg-[#71C0BB] text-[#332D56] rounded-md hover:bg-[#4E6688] hover:text-[#E3EEB2] disabled:opacity-50 transition-all duration-200 transform hover:scale-105 hover:shadow-lg flex items-center justify-center min-w-[120px] font-medium"
                disabled={loading || summarizing}
              >
                {summarizing ? (
                  <svg className="animate-spin h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
